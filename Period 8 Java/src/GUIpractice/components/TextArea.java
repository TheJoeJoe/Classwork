...
public class TextArea extends TextLabel {
	...
	public void update(Graphics2D g) {
		...
		if (getText() != null) { // split text into array of words
			String[] words = getText().split(" ");
			if (words.length > 0) { // index of word
				int i = 0;
				final int SPACING = 2; // y value represents y-coordinate of
										// each line
				...
				while (i < words.length) { // addto current line until
											// horizontal space is outside of //
											// bounds
